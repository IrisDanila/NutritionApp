...
export const FOODS: FoodItem[] = [
  ...
  // Food-101 dataset (for AI predictions)
  { name: "Apple Pie", query: "1 slice (~125g)", nutrients: { calories: 296, protein_g: 2.4, fat_g: 14.0, carbs_g: 41, fiber_g: 2, sugar_g: 20 } },
  { name: "Baby Back Ribs", query: "1 serving (~150g)", nutrients: { calories: 390, protein_g: 27, fat_g: 28, carbs_g: 8, fiber_g: 0, sugar_g: 6 } },
  { name: "Baklava", query: "1 piece (~50g)", nutrients: { calories: 220, protein_g: 3, fat_g: 14, carbs_g: 22, fiber_g: 1, sugar_g: 14 } },
  { name: "Beef Carpaccio", query: "100g", nutrients: { calories: 180, protein_g: 20, fat_g: 10, carbs_g: 1, fiber_g: 0, sugar_g: 0 } },
  { name: "Beef Tartare", query: "100g", nutrients: { calories: 220, protein_g: 20, fat_g: 15, carbs_g: 2, fiber_g: 0, sugar_g: 0 } },
  { name: "Beet Salad", query: "1 cup (~150g)", nutrients: { calories: 110, protein_g: 3, fat_g: 5, carbs_g: 16, fiber_g: 3, sugar_g: 9 } },
  { name: "Beignets", query: "2 pieces (~70g)", nutrients: { calories: 240, protein_g: 4, fat_g: 10, carbs_g: 33, fiber_g: 1, sugar_g: 12 } },
  { name: "Bibimbap", query: "1 bowl (~450g)", nutrients: { calories: 550, protein_g: 22, fat_g: 18, carbs_g: 78, fiber_g: 6, sugar_g: 8 } },
  { name: "Bread Pudding", query: "1 serving (~150g)", nutrients: { calories: 260, protein_g: 6, fat_g: 9, carbs_g: 39, fiber_g: 1, sugar_g: 23 } },
  { name: "Breakfast Burrito", query: "1 burrito (~250g)", nutrients: { calories: 550, protein_g: 22, fat_g: 28, carbs_g: 50, fiber_g: 5, sugar_g: 4 } },
  { name: "Bruschetta", query: "2 pieces (~100g)", nutrients: { calories: 170, protein_g: 5, fat_g: 6, carbs_g: 24, fiber_g: 2, sugar_g: 4 } },
  { name: "Caesar Salad", query: "1 serving (~250g)", nutrients: { calories: 470, protein_g: 10, fat_g: 41, carbs_g: 13, fiber_g: 3, sugar_g: 3 } },
  { name: "Cannoli", query: "1 piece (~85g)", nutrients: { calories: 220, protein_g: 5, fat_g: 10, carbs_g: 28, fiber_g: 1, sugar_g: 15 } },
  { name: "Caprese Salad", query: "1 plate (~200g)", nutrients: { calories: 250, protein_g: 12, fat_g: 18, carbs_g: 8, fiber_g: 2, sugar_g: 6 } },
  { name: "Carrot Cake", query: "1 slice (~100g)", nutrients: { calories: 350, protein_g: 4, fat_g: 16, carbs_g: 50, fiber_g: 2, sugar_g: 34 } },
  { name: "Ceviche", query: "1 serving (~200g)", nutrients: { calories: 200, protein_g: 22, fat_g: 5, carbs_g: 14, fiber_g: 1, sugar_g: 3 } },
  { name: "Cheesecake", query: "1 slice (~125g)", nutrients: { calories: 400, protein_g: 6, fat_g: 28, carbs_g: 32, fiber_g: 1, sugar_g: 26 } },
  { name: "Cheese Plate", query: "100g", nutrients: { calories: 350, protein_g: 20, fat_g: 28, carbs_g: 3, fiber_g: 0, sugar_g: 1 } },
  { name: "Chicken Curry", query: "1 cup (~240g)", nutrients: { calories: 300, protein_g: 20, fat_g: 14, carbs_g: 20, fiber_g: 3, sugar_g: 5 } },
  { name: "Chicken Quesadilla", query: "1 quesadilla (~200g)", nutrients: { calories: 450, protein_g: 25, fat_g: 22, carbs_g: 38, fiber_g: 3, sugar_g: 3 } },
  { name: "Chicken Wings", query: "4 wings (~120g)", nutrients: { calories: 350, protein_g: 28, fat_g: 24, carbs_g: 2, fiber_g: 0, sugar_g: 0 } },
  { name: "Chocolate Cake", query: "1 slice (~100g)", nutrients: { calories: 350, protein_g: 4, fat_g: 15, carbs_g: 53, fiber_g: 2, sugar_g: 38 } },
  { name: "Chocolate Mousse", query: "1/2 cup (~120g)", nutrients: { calories: 230, protein_g: 4, fat_g: 14, carbs_g: 24, fiber_g: 1, sugar_g: 20 } },
  { name: "Churros", query: "2 pieces (~90g)", nutrients: { calories: 280, protein_g: 4, fat_g: 14, carbs_g: 34, fiber_g: 2, sugar_g: 12 } },
  { name: "Clam Chowder", query: "1 cup (~245g)", nutrients: { calories: 200, protein_g: 7, fat_g: 9, carbs_g: 22, fiber_g: 2, sugar_g: 3 } },
  { name: "Club Sandwich", query: "1 sandwich (~250g)", nutrients: { calories: 500, protein_g: 26, fat_g: 26, carbs_g: 41, fiber_g: 3, sugar_g: 4 } },
  { name: "Crab Cakes", query: "2 cakes (~140g)", nutrients: { calories: 300, protein_g: 20, fat_g: 16, carbs_g: 20, fiber_g: 1, sugar_g: 2 } },
  { name: "Creme Brulee", query: "1 ramekin (~150g)", nutrients: { calories: 330, protein_g: 5, fat_g: 22, carbs_g: 28, fiber_g: 0, sugar_g: 26 } },
  { name: "Croque Madame", query: "1 sandwich (~250g)", nutrients: { calories: 600, protein_g: 30, fat_g: 38, carbs_g: 35, fiber_g: 2, sugar_g: 5 } },
  { name: "Cup Cakes", query: "1 cupcake (~60g)", nutrients: { calories: 200, protein_g: 2, fat_g: 8, carbs_g: 30, fiber_g: 1, sugar_g: 20 } },
  { name: "Deviled Eggs", query: "2 halves (~50g)", nutrients: { calories: 120, protein_g: 6, fat_g: 9, carbs_g: 1, fiber_g: 0, sugar_g: 0 } },
  { name: "Donuts", query: "1 donut (~70g)", nutrients: { calories: 260, protein_g: 3, fat_g: 14, carbs_g: 31, fiber_g: 1, sugar_g: 14 } },
  { name: "Dumplings", query: "6 pieces (~150g)", nutrients: { calories: 320, protein_g: 12, fat_g: 10, carbs_g: 45, fiber_g: 2, sugar_g: 2 } },
  { name: "Edamame", query: "1 cup (155g)", nutrients: { calories: 188, protein_g: 18.5, fat_g: 8.1, carbs_g: 13.8, fiber_g: 8.1, sugar_g: 3.4 } },
  { name: "Eggs Benedict", query: "1 serving (~220g)", nutrients: { calories: 450, protein_g: 20, fat_g: 30, carbs_g: 26, fiber_g: 1, sugar_g: 2 } },
  { name: "Escargots", query: "6 pieces (~150g)", nutrients: { calories: 180, protein_g: 20, fat_g: 8, carbs_g: 2, fiber_g: 0, sugar_g: 0 } },
  { name: "Falafel", query: "3 pieces (~85g)", nutrients: { calories: 333, protein_g: 9.3, fat_g: 17, carbs_g: 35, fiber_g: 6, sugar_g: 2 } },
  { name: "Filet Mignon", query: "100g", nutrients: { calories: 250, protein_g: 26, fat_g: 16, carbs_g: 0, fiber_g: 0, sugar_g: 0 } },
  { name: "Fish and Chips", query: "1 plate (~350g)", nutrients: { calories: 800, protein_g: 30, fat_g: 40, carbs_g: 80, fiber_g: 5, sugar_g: 6 } },
  { name: "Foie Gras", query: "60g", nutrients: { calories: 250, protein_g: 8, fat_g: 24, carbs_g: 2, fiber_g: 0, sugar_g: 0 } },
  { name: "French Fries", emoji: "🍟", query: "1 medium (~117g)", nutrients: { calories: 365, protein_g: 4, fat_g: 17, carbs_g: 48, fiber_g: 4, sugar_g: 0.3 } },
  { name: "French Onion Soup", query: "1 bowl (~250g)", nutrients: { calories: 200, protein_g: 8, fat_g: 10, carbs_g: 18, fiber_g: 2, sugar_g: 4 } },
  { name: "French Toast", query: "2 slices (~120g)", nutrients: { calories: 300, protein_g: 9, fat_g: 11, carbs_g: 41, fiber_g: 2, sugar_g: 9 } },
  { name: "Fried Calamari", query: "100g", nutrients: { calories: 175, protein_g: 15, fat_g: 7, carbs_g: 12, fiber_g: 1, sugar_g: 1 } },
  { name: "Fried Rice", query: "1 cup (~200g)", nutrients: { calories: 330, protein_g: 8, fat_g: 10, carbs_g: 50, fiber_g: 2, sugar_g: 3 } },
  { name: "Frozen Yogurt", query: "1 cup (~200g)", nutrients: { calories: 220, protein_g: 6, fat_g: 3, carbs_g: 44, fiber_g: 0, sugar_g: 36 } },
  { name: "Garlic Bread", query: "2 slices (~80g)", nutrients: { calories: 240, protein_g: 6, fat_g: 10, carbs_g: 31, fiber_g: 2, sugar_g: 2 } },
  { name: "Gnocchi", query: "1 cup (~250g)", nutrients: { calories: 300, protein_g: 7, fat_g: 3, carbs_g: 60, fiber_g: 3, sugar_g: 2 } },
  { name: "Greek Salad", query: "1 serving (~250g)", nutrients: { calories: 220, protein_g: 4.5, fat_g: 18, carbs_g: 9, fiber_g: 2.5, sugar_g: 4 } },
  { name: "Grilled Cheese Sandwich", query: "1 sandwich (~150g)", nutrients: { calories: 400, protein_g: 15, fat_g: 22, carbs_g: 36, fiber_g: 2, sugar_g: 4 } },
  { name: "Grilled Salmon", emoji: "🐟", query: "100g", nutrients: { calories: 208, protein_g: 22.1, fat_g: 13.4, carbs_g: 0, fiber_g: 0, sugar_g: 0 } },
  { name: "Guacamole", query: "1/2 cup (~120g)", nutrients: { calories: 200, protein_g: 3, fat_g: 18, carbs_g: 10, fiber_g: 7, sugar_g: 1 } },
  { name: "Gyoza", query: "6 pieces (~150g)", nutrients: { calories: 320, protein_g: 12, fat_g: 10, carbs_g: 45, fiber_g: 2, sugar_g: 2 } },
  { name: "Hamburger", emoji: "🍔", query: "1 sandwich (~200g)", nutrients: { calories: 350, protein_g: 20, fat_g: 17, carbs_g: 30, fiber_g: 2, sugar_g: 5 } },
  { name: "Hot and Sour Soup", query: "1 cup (~240g)", nutrients: { calories: 150, protein_g: 8, fat_g: 6, carbs_g: 16, fiber_g: 2, sugar_g: 3 } },
  { name: "Hot Dog", emoji: "🌭", query: "1 hot dog (~100g)", nutrients: { calories: 290, protein_g: 10, fat_g: 26, carbs_g: 4, fiber_g: 0, sugar_g: 1 } },
  { name: "Huevos Rancheros", query: "1 plate (~250g)", nutrients: { calories: 350, protein_g: 17, fat_g: 18, carbs_g: 30, fiber_g: 5, sugar_g: 4 } },
  { name: "Hummus", query: "2 tbsp (30g)", nutrients: { calories: 70, protein_g: 2, fat_g: 5, carbs_g: 4, fiber_g: 1, sugar_g: 0.1 } },
  { name: "Ice Cream", emoji: "🍨", query: "1/2 cup (66g)", nutrients: { calories: 137, protein_g: 2.3, fat_g: 7.3, carbs_g: 16, fiber_g: 0, sugar_g: 14 } },
  { name: "Lasagna", query: "1 piece (~250g)", nutrients: { calories: 500, protein_g: 25, fat_g: 25, carbs_g: 45, fiber_g: 4, sugar_g: 6 } },
  { name: "Lobster Bisque", query: "1 cup (~240g)", nutrients: { calories: 230, protein_g: 9, fat_g: 16, carbs_g: 14, fiber_g: 1, sugar_g: 4 } },
  { name: "Lobster Roll Sandwich", query: "1 sandwich (~200g)", nutrients: { calories: 450, protein_g: 22, fat_g: 20, carbs_g: 44, fiber_g: 2, sugar_g: 4 } },
  { name: "Macaroni and Cheese", query: "1 cup (~200g)", nutrients: { calories: 310, protein_g: 10, fat_g: 12, carbs_g: 40, fiber_g: 2, sugar_g: 5 } },
  { name: "Macarons", query: "3 cookies (~60g)", nutrients: { calories: 240, protein_g: 5, fat_g: 10, carbs_g: 32, fiber_g: 1, sugar_g: 24 } },
  { name: "Miso Soup", query: "1 cup (~240g)", nutrients: { calories: 80, protein_g: 6, fat_g: 3, carbs_g: 7, fiber_g: 1, sugar_g: 2 } },
  { name: "Mussels", query: "100g", nutrients: { calories: 172, protein_g: 24, fat_g: 4.5, carbs_g: 7, fiber_g: 0, sugar_g: 0 } },
  { name: "Nachos", query: "1 plate (~200g)", nutrients: { calories: 500, protein_g: 14, fat_g: 26, carbs_g: 54, fiber_g: 6, sugar_g: 4 } },
  { name: "Omelette", query: "1 omelette (~200g)", nutrients: { calories: 280, protein_g: 18, fat_g: 20, carbs_g: 4, fiber_g: 0, sugar_g: 2 } },
  { name: "Onion Rings", query: "1 serving (~150g)", nutrients: { calories: 400, protein_g: 5, fat_g: 22, carbs_g: 46, fiber_g: 3, sugar_g: 4 } },
  { name: "Oysters", query: "6 medium (~84g)", nutrients: { calories: 70, protein_g: 8, fat_g: 2, carbs_g: 4, fiber_g: 0, sugar_g: 0 } },
  { name: "Pad Thai", query: "1 plate (~400g)", nutrients: { calories: 600, protein_g: 20, fat_g: 20, carbs_g: 85, fiber_g: 4, sugar_g: 18 } },
  { name: "Paella", query: "1 plate (~400g)", nutrients: { calories: 500, protein_g: 25, fat_g: 14, carbs_g: 65, fiber_g: 4, sugar_g: 6 } },
  { name: "Pancakes", emoji: "🥞", query: "2 medium pancakes (~150g)", nutrients: { calories: 175, protein_g: 4, fat_g: 4.5, carbs_g: 30, fiber_g: 1, sugar_g: 6 } },
  { name: "Panna Cotta", query: "1 serving (~150g)", nutrients: { calories: 300, protein_g: 4, fat_g: 20, carbs_g: 26, fiber_g: 0, sugar_g: 22 } },
  { name: "Peking Duck", query: "100g", nutrients: { calories: 300, protein_g: 19, fat_g: 24, carbs_g: 2, fiber_g: 0, sugar_g: 0 } },
  { name: "Pho", query: "1 bowl (~500g)", nutrients: { calories: 450, protein_g: 30, fat_g: 10, carbs_g: 60, fiber_g: 4, sugar_g: 6 } },
  { name: "Pizza", emoji: "🍕", query: "1 slice (~140g)", nutrients: { calories: 340, protein_g: 14, fat_g: 16, carbs_g: 32, fiber_g: 2, sugar_g: 4 } },
  { name: "Pork Chop", query: "100g", nutrients: { calories: 231, protein_g: 27, fat_g: 13, carbs_g: 0, fiber_g: 0, sugar_g: 0 } },
  { name: "Poutine", query: "1 plate (~300g)", nutrients: { calories: 700, protein_g: 16, fat_g: 36, carbs_g: 82, fiber_g: 5, sugar_g: 4 } },
  { name: "Prime Rib", query: "100g", nutrients: { calories: 300, protein_g: 24, fat_g: 22, carbs_g: 0, fiber_g: 0, sugar_g: 0 } },
  { name: "Pulled Pork Sandwich", query: "1 sandwich (~250g)", nutrients: { calories: 550, protein_g: 28, fat_g: 24, carbs_g: 52, fiber_g: 3, sugar_g: 10 } },
  { name: "Ramen", query: "1 bowl (~400g)", nutrients: { calories: 500, protein_g: 20, fat_g: 18, carbs_g: 64, fiber_g: 3, sugar_g: 6 } },
  { name: "Ravioli", query: "1 cup (~250g)", nutrients: { calories: 330, protein_g: 12, fat_g: 8, carbs_g: 52, fiber_g: 3, sugar_g: 4 } },
  { name: "Red Velvet Cake", query: "1 slice (~100g)", nutrients: { calories: 350, protein_g: 4, fat_g: 16, carbs_g: 49, fiber_g: 1, sugar_g: 36 } },
  { name: "Risotto", query: "1 cup (~250g)", nutrients: { calories: 330, protein_g: 8, fat_g: 10, carbs_g: 52, fiber_g: 2, sugar_g: 3 } },
  { name: "Samosa", query: "2 pieces (~120g)", nutrients: { calories: 300, protein_g: 6, fat_g: 14, carbs_g: 38, fiber_g: 4, sugar_g: 4 } },
  { name: "Sashimi", query: "100g", nutrients: { calories: 130, protein_g: 23, fat_g: 4, carbs_g: 0, fiber_g: 0, sugar_g: 0 } },
  { name: "Scallops", query: "100g", nutrients: { calories: 111, protein_g: 20, fat_g: 1, carbs_g: 5, fiber_g: 0, sugar_g: 0 } },
  { name: "Seaweed Salad", query: "1 cup (~150g)", nutrients: { calories: 130, protein_g: 3, fat_g: 7, carbs_g: 14, fiber_g: 2, sugar_g: 6 } },
  { name: "Shrimp and Grits", query: "1 plate (~350g)", nutrients: { calories: 450, protein_g: 25, fat_g: 18, carbs_g: 45, fiber_g: 2, sugar_g: 4 } },
  { name: "Spaghetti Bolognese", query: "1 plate (~400g)", nutrients: { calories: 680, protein_g: 28, fat_g: 22, carbs_g: 86, fiber_g: 6, sugar_g: 10 } },
  { name: "Spaghetti Carbonara", query: "1 plate (~350g)", nutrients: { calories: 650, protein_g: 22, fat_g: 28, carbs_g: 70, fiber_g: 3, sugar_g: 5 } },
  { name: "Spring Rolls", query: "4 pieces (~160g)", nutrients: { calories: 300, protein_g: 8, fat_g: 10, carbs_g: 45, fiber_g: 3, sugar_g: 3 } },
  { name: "Steak", emoji: "🥩", query: "100g", nutrients: { calories: 250, protein_g: 26, fat_g: 17, carbs_g: 0, fiber_g: 0, sugar_g: 0 } },
  { name: "Strawberry Shortcake", query: "1 serving (~150g)", nutrients: { calories: 300, protein_g: 5, fat_g: 12, carbs_g: 42, fiber_g: 2, sugar_g: 24 } },
  { name: "Sushi", emoji: "🍣", query: "8 pieces (~200g)", nutrients: { calories: 320, protein_g: 12, fat_g: 6, carbs_g: 54, fiber_g: 3, sugar_g: 6 } },
  { name: "Tacos", emoji: "🌮", query: "3 tacos (~180g)", nutrients: { calories: 450, protein_g: 20, fat_g: 18, carbs_g: 48, fiber_g: 6, sugar_g: 4 } },
  { name: "Takoyaki", query: "6 balls (~150g)", nutrients: { calories: 300, protein_g: 12, fat_g: 12, carbs_g: 36, fiber_g: 1, sugar_g: 2 } },
  { name: "Tiramisu", query: "1 slice (~120g)", nutrients: { calories: 350, protein_g: 6, fat_g: 22, carbs_g: 34, fiber_g: 1, sugar_g: 24 } },
  { name: "Tuna Tartare", query: "100g", nutrients: { calories: 160, protein_g: 23, fat_g: 6, carbs_g: 1, fiber_g: 0, sugar_g: 0 } },
  { name: "Waffles", emoji: "🧇", query: "1 waffle (~75g)", nutrients: { calories: 218, protein_g: 4.4, fat_g: 11, carbs_g: 26, fiber_g: 1, sugar_g: 5 } }
];
